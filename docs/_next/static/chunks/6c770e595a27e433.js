...
`;function h(){return(0,t.jsx)(l.CodePreview,{code:f})}let x=`function App() {
  return (
    <TButton
      status="primary"
      onClick={() => {
...
}`;function v(){return(0,t.jsx)(l.CodePreview,{code:x})}let g=`function App() {
  return (
    <TButton
      status="primary"
      onClick={() => {
