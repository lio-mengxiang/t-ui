...
};`,language:"jsx"}),"\n",(0,n.jsxs)(i.ul,{children:["\n",(0,n.jsxs)(i.li,{children:["首先我们固定了背景黑色蒙版的样式，也就是 ",(0,n.jsx)(i.code,{children:"maskCls"}),"。这里使用了 ",(0,n.jsx)(i.code,{children:"position: fixed"})," 来覆盖整个页面。"]}),"\n",(0,n.jsxs)(i.li,{children:["然后设置了 ",(0,n.jsx)(i.code,{children:"modal"})," 在容器中的位置，使用 ",(0,n.jsx)(i.code,{children:"containerClassName"})," 来设置，可以看到下面是居中显示的，并且默认因为挂载\n到 ",(0,n.jsx)(i.code,{children:"document.body"})," 上。所以使用了 ",(0,n.jsx)(i.code,{children:"position: fixed"})," 来居中到屏幕上。"]}),"\n"]}),"\n",(0,n.jsxs)(i.p,{children:["当然还可以自己传入 ",(0,n.jsx)(i.code,{children:"attach"})," 参数，自定义需要挂载的元素上，传入的是一个字符串，内部会用 ",(0,n.jsx)(i.code,{children:"document.querySelector"})," 来查询元素。\n这里为什么不直接传入 ",(0,n.jsx)(i.code,{children:"dom"})," 元素，而是传入一个字符串，是因为我们希望可以在 ",(0,n.jsx)(i.code,{children:"服务端渲染"})," 时，直接使用 ",(0,n.jsx)(i.code,{children:"document"})," 或者 ",(0,n.jsx)(i.code,{children:"window"})," 是不允许的。\n所以干脆就传入字符串，在组件内部的 ",(0,n.jsx)(i.code,{children:"useEffect"})," 中，使用 ",(0,n.jsx)(i.code,{children:"document.querySelector"})," 来查询元素。"]}),"\n",(0,n.jsxs)(i.ul,{children:["\n",(0,n.jsxs)(i.li,{children:[(0,n.jsx)(i.code,{children:"initialFocusEl"})," 表示是否需要将焦点锁定到第一个可聚焦的元素上。这是一个函数，里面一般都是用 ",(0,n.jsx)(i.code,{children:"ref"})," 获取到该元素，然后调用 ",(0,n.jsx)(i.code,{children:"focus"})," 方法来获取焦点。"]}),"\n",(0,n.jsxs)(i.li,{children:[(0,n.jsx)(i.code,{children:"onCancel"})," 表示点击取消按钮时的回调函数，一般会用来关闭 ",(0,n.jsx)(i.code,{children:"modal"})," 组件。"]}),"\n",(0,n.jsxs)(i.li,{children:[(0,n.jsx)(i.code,{children:"content"})," 表示 ",(0,n.jsx)(i.code,{children:"modal"})," 组件的内容，一般是一个 ",(0,n.jsx)(i.code,{children:"ReactNode"})," 类型的元素。这里我们使用了 ",(0,n.jsx)(i.code,{children:"Alert"})," 章节自定义的 ·",(0,n.jsx)(i.code,{children:"Modal"})," 组件来包裹内容。你也完全可以定义自己的 ",(0,n.jsx)(i.code,{children:"modal"})," 组件。从而达到函数调用的方式传入参数的效果。"]}),"\n"]}),"\n",(0,n.jsxs)(i.p,{children:["在 ",(0,n.jsx)(i.code,{children:"TModalBox"})," 中，我们默认把关闭功能添加进来，使用 ",(0,n.jsx)(i.code,{children:"modalStore.remove(id);"})," 来实现关闭弹框。接收的 ",(0,n.jsx)(i.code,{children:"id"})," 正是 ",(0,n.jsx)(i.code,{children:"add"})," 方法返回的 ",(0,n.jsx)(i.code,{children:"id"}),"。表示我们要操作哪个弹窗。"]}),"\n",(0,n.jsxs)(i.p,{children:["其中注意的是， ",(0,n.jsx)(i.code,{children:"TModalBox"})," 中的确定按钮，有时候我们需要异步关闭，比如将表单数据发送给后端成功后关闭弹窗。此时一般会有一个 ",(0,n.jsx)(i.code,{children:"loading"})," 参数传入到 ",(0,n.jsx)(i.code,{children:"TModalBox"})," 中的确定按钮，有时候我们需要异步关闭，比如将表单数据发送给后端成功后关闭弹窗。此时一般会有一个\n",(0,n.jsx)(i.code,{children:"loading"})," 参数传给这个确定按钮，用来表示是否正在等待后端返回数据中。"]}),"\n",(0,n.jsxs)(i.p,{children:["如何给 ",(0,n.jsx)(i.code,{children:"TModalBox"})," 更新参数呢？可以使用 ",(0,n.jsx)(i.code,{children:"modalStore.update(id, { contentProps: { loading: true } });"})," 方法来更新 ",(0,n.jsx)(i.code,{children:"modal"})," 组件的参数。"]}),"\n",(0,n.jsxs)(i.p,{children:["其中 ",(0,n.jsx)(i.code,{children:"id"})," 是 ",(0,n.jsx)(i.code,{children:"add"})," 方法返回的 ",(0,n.jsx)(i.code,{children:"id"}),"，表示我们要操作哪个弹窗。 ",(0,n.jsx)(i.code,{children:"contentProps"})," 是专门给 ",(0,n.jsx)(i.code,{children:"content"})," 传入的组件的参数。"]}),"\n",(0,n.jsxs)(i.p,{children:["其中还有一个 ",(0,n.jsx)(i.code,{children:"cs"})," 方法，实际上就是 ",(0,n.jsx)(i.code,{children:"classnames"})," 库的 ",(0,n.jsx)(i.code,{children:"cs"})," 方法，用来合并类名的。当然因为 ",(0,n.jsx)(i.code,{children:"tailwindcss"})," 合并类名还需要 ",(0,n.jsx)(i.code,{children:"tailwind-merge"})," 库协助，所以这个 ",(0,n.jsx)(i.code,{children:"cs"})," 方法是结合了两者。"]}),"\n",(0,n.jsx)(i.h2,{children:"2、删除 modal"}),"\n",(0,n.jsxs)(i.p,{children:["上面液体提到删除 ",(0,n.jsx)(i.code,{children:"modal"})," 的方式，我们补充一个 ",(0,n.jsx)(i.code,{children:"remove"})," 方法，用来手动删除 ",(0,n.jsx)(i.code,{children:"modal"})," 组件。"]}),"\n",(0,n.jsx)(r.CodeBlock,{code:`import { modalStore } from '@/layout';
import { TModalBox } from '@/alert/t-modal-box';
...
};`,language:"jsx"}),"\n",(0,n.jsxs)(i.p,{children:[(0,n.jsx)(i.code,{children:"id"})," 是 ",(0,n.jsx)(i.code,{children:"add"})," 方法返回的 ",(0,n.jsx)(i.code,{children:"id"}),"，表示我们要操作哪个弹窗。其实也支持在 ",(0,n.jsx)(i.code,{children:"add"})," 方式自定义 ",(0,n.jsx)(i.code,{children:"id"}),"，但是一般情况下用内部会自动生成，免去传入的麻烦。"]}),"\n",(0,n.jsx)(i.h2,{children:"3、更新 modal"}),"\n",(0,n.jsxs)(i.p,{children:["更新 ",(0,n.jsx)(i.code,{children:"modal"})," 也很简单，直接使用 ",(0,n.jsx)(i.code,{children:"update"})," 方法即可。"]}),"\n",(0,n.jsx)(r.CodeBlock,{code:`import { modalStore } from '@/layout';
import { TModalBox } from '@/alert/t-modal-box';
...
};`,language:"jsx"}),"\n",(0,n.jsx)(i.h2,{children:"欢迎加入简历亮点交流群"}),"\n",(0,n.jsx)(s.Promote,{})]})}function d(e={}){let{wrapper:t}={...(0,o.useMDXComponents)(),...e.components};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(i,{...e})}):i(e)}function a(){return(0,n.jsx)(d,{})}e.s(["HowMakeCssToast",()=>a],52221)}]);