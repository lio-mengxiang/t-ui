...
`;function l(){return(0,t.jsx)(i.CodePreview,{code:u})}let d=`
const Card = () => {
  return (
...
`;function p(){return(0,t.jsx)(i.CodePreview,{code:d})}let m=`
function App() {
  let index = 1;
  return (
    <TButton
...
`;function f(){return(0,t.jsx)(i.CodePreview,{code:m})}let x=`
function App() {
  return (
    <div className="flex gap-x-2">
      <TButton
