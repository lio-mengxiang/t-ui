<!-- <template>
    <div v-bind="getWrapperAttrs($attrs)" :class="wrapperCls" @mousedown="handleMousedown">
        ...
        <resize-observer @resize="handleResize">
            <textarea ref="textareaRef" v-bind="mergeTextareaAttrs" :disabled="mergedDisabled" :class="prefixCls"
                :style="textareaStyle" :value="computedValue" :placeholder="placeholder" @input="handleInput"
                @focus="handleFocus" @blur="handleBlur" @compositionstart="handleComposition"
