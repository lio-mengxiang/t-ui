...
import { InputTag, IconCopyLine } from '@/icon/line';
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        apple,banana,orange <IconCopyLine className="cursor-pointer text-[12px]" onClick={() => navigator.clipboard.writeText('apple,banana,orange')} />
      </div>
      <InputTag.Root
        tokenSeparators={[',']}
