...
export function Page2({ goToPage, router }: { goToPage: (isOverlay?: boolean) => void; router: any }) {
  ...
  return (
    <div>
      <div ref={container}>
        <div className="h-[calc(var(--dvh)*100)] bg-[#f6c646] relative overflow-hidden no-scrollbar">
          <motion.div className="flex justify-center" initial={{ y: 100 }} animate={{ y: 0 }} transition={{ delay: 0.3, duration: 0.4 }}>
            ...
            <Card />
            <div className="absolute bottom-[1.5vh] left-[50%] translate-x-[-50%] flex items-center">
              <ScrollIcon />
