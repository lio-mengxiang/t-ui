export function ScrollIcon() {
  return (
    <svg className="w-[6vh] mt-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="46" height="46" color="color-1" fill="none">
      <path
        d="M12 22C18 22 19.5 17.49 19.5 12C19.5 6.50998 18 2 12 2C5.99993 2 4.5 6.50996 4.5 12C4.5 17.49 5.99993 22 12 22Z"
        stroke="currentColor"
        strokeWidth="1.5"
      ></path>
      <g stroke="currentColor" className="mouse-up-down">
        <path d="M11.9883 6.83859L11.9883 11.7586" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
        <path
