...
export function CodeTab({ code, cssCode, onChange, onCssChange, cssEditable }: JsPreviewProps) {
        ...
        <AnimatePresence>
          ...
          {cssCode && (
            <m.div className="overflow-hidden" ref={scopeCSS} initial={{ height: 0 }} key={2}>
              <CssPreview cssCode={cssCode} onCssChange={onCssChange} cssEditable={cssEditable} />
            </m.div>
          )}
        </AnimatePresence>
      </LazyMotion>
