...
export const TDrawerBox: React.FC<PropsWithChildren<ModalProps>> = ({
  title,
  showCloseIcon = false,
  onCancel,
  showFooter,
  ...
  return (
    <div className={cs('grid gap-6 overflow-y-auto text-color bg-color p-6 overflow-hidden content-between', className)} style={style}>
