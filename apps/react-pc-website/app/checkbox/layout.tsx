      ...
      items: [
        {
          ...
          onClick: () => {
            router.push('/checkbox/example/tailwind-traditional-example');
          },
          value: '/checkbox/example/tailwind-traditional-example',
        },
        {
          content: <MenuItem className="text-sm font-light">创意案例</MenuItem>,
          onClick: () => {
            router.push('/checkbox/example/tailwind-creative-example');
          },
          value: '/checkbox/example/tailwind-creative-example',
        },
      ],
    },
  ];
