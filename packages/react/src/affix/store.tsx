...
import { debounceByRaf, useEvent } from '../hooks';
import { isFunction, isWindow } from '../utils';
// type
...
export function useStore(props: useStoreProps & { fixedClassName?: string }) {
  // data
  const { fixedClassName, zIndex, container, offsetBottom, offsetTop, onFixedChange, isInScrollContainer } = props;
  // dom ref
